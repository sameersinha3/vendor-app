    ...
    <body class="container2_box">
        ...
        if($vet['active'] == 0){
            ...
            echo "<div class='title_box center_row'>";
                echo "<span>Manage your Applications</span>";
            echo "</div>";
            ...
            echo "<div class='container_tab'>";
                echo "<table class='tab'>";
                    echo "<tr class='tab_index'>";
                        ...
                        echo "<td>Delete</td>";
                    echo "</tr>";
                    $sql = mysqli_query($conn, "SELECT * FROM application WHERE id_user = $id");
                    if(mysqli_num_rows($sql) > 0){
                        ...
                        echo "<tr class='tab_element'>";
                            echo "<td colspan='9' style='padding-top: 10px; padding-bottom: 0;'>When you create an Application you will find it here</td>";
                        echo "</tr>";
                    }
                echo "</table>";
            echo "</div>";
